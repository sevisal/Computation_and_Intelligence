...
In this activity you will learn to load a dataset in Orange and explore its content using available widgets. To do this:![Source: Loofandjimmy.com](_resources/images/titanic.gif){.img-right}
...
![Figure: Counting error](_resources/images/counting.gif){.img-right}
...
![Figure: Selection](_resources/images/selection.gif){.img-right}
Not all variables in a dataset are equally useful for analysis or modeling. In this activity you will learn to select and focus on the most relevant variables, improving efficiency and effectiveness. To do this:
...
![Figure: Error](_resources/images/error.jpg){.img-right}
