...
Not all variables in a dataset are equally useful for analysis or modeling. In this activity you will learn to select and focus on the most relevant variables, improving efficiency and effectiveness. To do this:![Figure: Selection](_resources/images/selection.gif){.img-right}
