...
En esta parte, conectarás los datos de entrenamiento a un widget **k-NN** en Orange, configurarás sus parámetros y entrenarás el modelo. Utiliza el widget **Scatter Plot** para visualizar cómo se distribuyen los puntos de datos respecto a las variables `HBB` y `HBD`.
