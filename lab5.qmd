...
In this second part, we will work with image data to explore clustering and low-dimensional embeddings. Specifically, we will use a subset of the **Fashion-MNIST** dataset (available [here](https://github.com/sevisal/Computation_and_Intelligence/blob/main/_resources/data/fashion-mnist_reduced.csv)).  
...
The **Fashion-MNIST** dataset contains grayscale images of 28×28 pixels, each corresponding to one of ten clothing categories codified in variable *label*.
