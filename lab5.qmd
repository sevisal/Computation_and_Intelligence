...
::: {.objective-card}
🎯 **General goal:** Explore unsupervised grouping of vehicles using a compact set of numeric features. Learn how K-Means discovers representative centroids, how to decide the number of clusters, and how to interpret the centroid profiles back in the original units.
:::
...
In this second part, we will work with image data — specifically, the **Fashion-MNIST** dataset — to explore clustering and low-dimensional embeddings.  
